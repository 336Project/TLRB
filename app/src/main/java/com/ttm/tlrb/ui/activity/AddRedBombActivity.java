...
public class AddRedBombActivity extends TitlebarActivity implements View.OnClickListener{
    ...
    private RadioButton mRbGril;//女方
    ...
    private void initView(){
        ...
        mRbGril=(RadioButton)findViewById(R.id.rb_gril);
    ...
    private void saveData(){
        ...
        redBomb.setMoney(mLayoutMoney.getEditText().getText().toString());
        redBomb.setGift(mLayoutGift.getEditText().getText().toString());
        if(mRbBoy.isChecked()){
            redBomb.setTarget(1+"");
        }else if(mRbGril.isChecked()){
            redBomb.setTarget(2+"");
        }else{
            redBomb.setTarget(3+"");
        }
