...
public class UpdateRedBombActivity extends TitlebarActivity implements View.OnClickListener{
    ...
    public static void launcher(Activity context, RedBomb redBomb, int requestCode){
        Intent intent = new Intent(context,UpdateRedBombActivity.class);
        intent.putExtra("redBomb",redBomb);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_red_bomb);
        initView();
...
//                ToastUtil.showToast(AddRedBombActivity.this,"获取组别失败");
                ...
                public void onNext(List<Category> categories) {
                    ...
                    final ArrayAdapter<String> adapter = new ArrayAdapter<String>(UpdateRedBombActivity.this, android.R.layout.simple_spinner_item, list);
        ...
        if(mSubscriberUpdate == null || mSubscriberUpdate.isUnsubscribed()){
            mSubscriberUpdate = new BaseSubscriber<BmobObject>(this) {
                ...
                public void atNext(BmobObject bmobObject) {
                    ...
                    ToastUtil.showToast(UpdateRedBombActivity.this, "修改数据成功");
                    finish();
                }

                @Override
                public void atError(Throwable e) {
                    ToastUtil.showToast(UpdateRedBombActivity.this, "修改数据失败，请重试");
                }
            };
        }
    ...
    private void deleteData(){
        if(mSubscriberDelete == null || mSubscriberDelete.isUnsubscribed()){
            mSubscriberDelete = new BaseSubscriber<BmobObject>(this) {
                ...
                public void atNext(BmobObject bmobObject) {
                    setResult(REFRESH_REDBOMBFRAGMENT);
                    ToastUtil.showToast(UpdateRedBombActivity.this, "删除成功");
                    finish();
                }

                @Override
                public void atError(Throwable e) {
                    ToastUtil.showToast(UpdateRedBombActivity.this, "删除数据失败，请重试");
                }
            };
        }
    ...
    private RedBomb checkInput(RedBomb redBomb){
        if(mLayoutMoney.getEditText().getText().toString().equals("")){
            ToastUtil.showToast(UpdateRedBombActivity.this,"金额不能为空");
            return null;
        }else if(Double.valueOf(mLayoutMoney.getEditText().getText().toString())<=0){
            ToastUtil.showToast(UpdateRedBombActivity.this,"金额要大于0元");
            return null;
        }
    ...
    private void setStartDate() {
        ...
        DatePickerView datePickerView = new DatePickerView(UpdateRedBombActivity.this,
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_update:
                MobclickAgent.onEvent(UpdateRedBombActivity.this, Constant.Event.EVENT_ID_BOMB_UPDATE);
            ...
            case R.id.btn_delete:
                MobclickAgent.onEvent(UpdateRedBombActivity.this, Constant.Event.EVENT_ID_BOMB_DELETE);
            ...
            case R.id.tv_addType:
                Intent intent =new Intent(UpdateRedBombActivity.this,GroupActivity.class);
