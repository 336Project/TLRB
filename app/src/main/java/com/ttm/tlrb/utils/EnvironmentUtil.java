...
public class EnvironmentUtil {
    ...
    public static boolean isNetworkConnected(){
        ConnectivityManager manager=(ConnectivityManager) RBApplication.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean isOpenGPS(){
        LocationManager alm = (LocationManager) RBApplication.getInstance().getSystemService(Context.LOCATION_SERVICE);
    ...
    public static String getPackageName(){
        return RBApplication.getInstance().getPackageName();
    }
    ...
    public static File getCacheFile(){
        return RBApplication.getInstance().getExternalCacheDir();
    }
    ...
    public static Point getScreenHW(){
        if(mScreenPoint == null) {
            WindowManager wm = (WindowManager) RBApplication.getInstance().getSystemService(Context.WINDOW_SERVICE);
